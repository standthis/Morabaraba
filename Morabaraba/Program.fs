...
module Game =
 open Players_
    ...
    let A1 = {Pos=('A',1);Layer=3;Status=None}
    let A4 = {Pos=('A',4);Layer=3;Status=None} 
    let A7 = {Pos=('A',7);Layer=3;Status=None}
    let B2 = {Pos=('B',2);Layer=2;Status=None}
    let B4 = {Pos=('B',4);Layer=2;Status=None}
    let B6 = {Pos=('B',6);Layer=2;Status=None}
    let C3 = {Pos=('C',3);Layer=1;Status=None}
    let C4 = {Pos=('C',4);Layer=1;Status=None}
    let C5 = {Pos=('C',5);Layer=1;Status=None}
    let D1 = {Pos=('D',1);Layer=3;Status=None}
    let D2 = {Pos=('D',2);Layer=2;Status=None}
    let D3 = {Pos=('D',3);Layer=1;Status=None}
    let D5 = {Pos=('D',5);Layer=1;Status=None};
    let D6 = {Pos=('D',6);Layer=2;Status=None};
    let D7 = {Pos=('D',7);Layer=3;Status=None};
    let E3 = {Pos=('E',3);Layer=1;Status=None};
    let E4 = {Pos=('E',4);Layer=1;Status=None};
    let E5 = {Pos=('E',5);Layer=1;Status=None};
    let F2 = {Pos=('F',2);Layer=2;Status=None};
    let F4 = {Pos=('F',4);Layer=2;Status=None};
    let F6 = {Pos=('F',6);Layer=2;Status=None};
    let G1 = {Pos=('G',1);Layer=3;Status=None};
    let G4 = {Pos=('G',4);Layer=3;Status=None}; 
    let G7 = {Pos=('G',7);Layer=3;Status=None}; 


    let startBoard=[A1;A4;A7;B2;B4;B6;C3;C4;C5;D1;D2;D3;D5;D6;D7;E3;E4;E5;F2;F4;F6;G1;G4;G7]
    let mills = [] //make this a list of all the possible mills that can be formed
    ...
    let getCoords character (pos:char*int) = //get the Coord type given pos and character to fill it with
        { ((List.filter (fun x-> x.Pos=pos)startBoard).[0]) with Status = Some character }
